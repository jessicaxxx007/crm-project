<!DOCTYPE html>
<html>
<head><title>字典管理</title><#include "../common.ftl"></head>
...
<form class="layui-form">
    ...
    <table id="dicList" class="layui-table" lay-filter="dics"></table>
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a class="layui-btn layui-btn-normal addNews_btn" lay-event="add"><i class="layui-icon">&#xe608;</i>添加字典</a>
            <a class="layui-btn layui-btn-normal delNews_btn" lay-event="del"><i class="layui-icon">&#xe608;</i>删除</a>
        </div>
    </script>
    <script id="dicListBar" type="text/html">
